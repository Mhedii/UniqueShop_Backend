...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ko4hjs5.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const database = client.db("unique_shop");
